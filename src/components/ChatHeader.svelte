<script>
    export let recentChatInfo = {};
</script>
<style>
/* light-mode */
:global(body) .chat-header{
...
/* dark-mode */
:global(body.dark-mode) .chat-header {
    background: #242526;
    color: #fff;
}

:global(body.dark-mode) .chat-header a {
...
<div class="chat-header px-6 py-4 flex flex-row flex-none justify-between items-center shadow">
                    <div class="flex">
                        <div class="w-12 h-12 mr-4 relative flex flex-shrink-0">
                            <img class="shadow-md rounded-full w-full h-full object-cover" src="{recentChatInfo.avatar}" alt="">
                        </div>
                        <div class="text-sm">
                            <p class="font-bold">{recentChatInfo.fullname}</p>
                            <!-- <p>Active {recentChatInfo.lastMessage}</p> -->
                            <p>12/10</p>
                        </div>
                    </div>
